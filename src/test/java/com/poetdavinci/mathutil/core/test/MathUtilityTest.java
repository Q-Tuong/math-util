package com.poetdavinci.mathutil.core.test;
...
class MathUtilityTest {
    ...
    // ngoại lệ có xh như dự kiến hay ko.. nếu có thì phải màu xanh!!!
    // NGHE KĨ: CÓ NGOẠI LỆ, NHƯNG LÀ MÀU XANH, VÌ NGOẠI LỆ XUẤT HIỆN NHƯ DỰ KIẾN
    @Test
    void getFactorialGivenWrongArgumentThrowsException(){
        // getFactorial(-5);
    ...
    // Cấu trúc test case: ID, Desc. Steps/Procedure, Expected result,
    ...
    void testFactorialGivenRightArgument0RunsWell() {
        ...
        // NÃO VÀ MẮT KHÔNG CẦN NHIÌN, ĐOÁN VÀ KẾT LUẬN NHƯ TRUYỀN THỐNG
...
// XONG CHẠY XANH ĐỎ, SỬA, CHẠY LẠI XANH ĐỎ, TỐI ƯU CHỈNH CODE, CHẠY LẠI XANH ĐỎ
