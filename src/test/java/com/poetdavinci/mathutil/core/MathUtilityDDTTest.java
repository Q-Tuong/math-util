package com.poetdavinci.mathutil.core;
...
class MathUtilityDDTTest {
    ...
    // KHỎI CÁC CÂU LỆNH KIỂM THỬ, MỤC ĐÍCH GIÚP DEVELOPER NHÌN NHANH DC XEM
    ...
    void testFactorialGivenWrongArgument5RunsWell(int n) {
